...
- [Pokedex]([https://github.com/cherrydub/fe-react-data-visualisation](https://pokedex-three-pink.vercel.app/)) for this project I was getting familiar with fetching API's, this one using the very popular PokeAPI, this was only a frontend project using React
